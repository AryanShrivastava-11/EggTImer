# EggTimer
  ...
  The app allows user to set the timer. After the timer is set, the progress bar shows the progress and an alarm is fire as soon as the timer is invalidated.
